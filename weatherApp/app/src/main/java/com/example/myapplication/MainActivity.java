...
//        textView.setText(findViewById(R.id.tv_address).getContext().toString());
//        layout.addView(textView);
        ((TextView)findViewById(R.id.show)).setText(((TextView)findViewById(R.id.tv_address)).getText().toString());
    }
